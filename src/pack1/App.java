...
public class App {
    public static void main(String[] args) {
        Hero[] arrhero = new Hero[2];
        Evil[] arrevil = new Evil[3];
        King king = new King("King", 500, "Небесный луч", 1000, 10000);
        king.setKazna(1000000);

        arrhero[0] = new Hero("Knight", 300, "Накапливаемое кровотечение", 550, 2000);
        arrhero[1] = new Hero("Unit", 150, "Выпад", 200, 1000);
